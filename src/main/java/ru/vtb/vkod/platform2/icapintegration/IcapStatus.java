 ...
 *
 * <p>This is a self-contained copy used by {@link IcapTestServer} so the whole test-server feature lives
 * in a single package and does not depend on the client starter.</p>
 */
